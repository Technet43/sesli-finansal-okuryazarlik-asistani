...
export function Sidebar(props: SidebarProps) {
  ...
  return (
    <aside
      aria-label="Ayarlar"
      className="glass-surface overflow-hidden rounded-2xl lg:sticky lg:top-6 lg:max-h-[calc(100svh-3rem)]"
    >
      <div className="sidebar-scroll flex flex-col gap-7 p-6 lg:max-h-[calc(100svh-3rem)] lg:overflow-y-auto lg:pr-5">
        ...
        <label className="block space-y-1.5" htmlFor="gemini-api-key">
          ...
          <span className="block text-xs leading-5 text-ink-muted">
            ...
            Boş bırakırsan AI çağrısı yapılmaz; kullanıcı kendi anahtarını girmelidir.
          </span>
        </label>
